...
const typeDefs = gql`
  ...
  type Mutation {
    addPrinter(printerName: String!, ipAddress: String!, printerStatus: StatusType): Printer
    updatePrinter(id: String!, printerName: String!, ipAddress: String!, printerStatus: StatusType): Printer
